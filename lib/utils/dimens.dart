...
class Dimens{
  ...
  static const EdgeInsets paddingInset = EdgeInsets.symmetric(vertical: Dimens.screenPaddingV * 4, horizontal: Dimens.screenPaddingH);
  static const EdgeInsets screenPaddingHV = EdgeInsets.symmetric(vertical: 17, horizontal: Dimens.space15);
  static const EdgeInsets screenPaddingHV1 = EdgeInsets.symmetric(vertical: 20, horizontal: 17);
  static const EdgeInsets previewPaddingHV = EdgeInsets.symmetric(vertical: 17, horizontal: Dimens.space15);
}